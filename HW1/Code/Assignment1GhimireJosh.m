...
% the mean of the means of each vector is the same as the mean of the separate vectors combined. 
...
% mean(ceil(V1)) will first try to round up all elements in V1 to the nearest positive integer. 
% As V1 is already a vector of integers, V1 will not be altered, and the mean of V1, which is 50.5, is calculated.  
...
% the standard error decreases since the sample mean is approaching the true value of the mean of the population data. 
