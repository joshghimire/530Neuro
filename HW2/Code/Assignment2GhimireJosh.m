...
v2Indices = find(vector2>=5 & vector2<=10 | vector2 >20);   % silenced due to length of result
v3Indices = find(vector3>=5 & vector3<=10 | vector3 >20);   % silenced
%% Q2. 
x = 10:20;
y = 10*(ones(1,11));
figure
...
legend('Goons', 'Homies')
% This makes more sense if you don't think about it.
%% Q5. 
figure
plotMyLine(1,2,'red')
